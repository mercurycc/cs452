...
#define TRAIN_TRAVEL_SPEED_2_LENGTH 2500
#define TRAIN_TRAVEL_SPEED_2        8
#define TRAIN_TRAVEL_SPEED_3_LENGTH 1200
#define TRAIN_TRAVEL_SPEED_3        6
#define TRAIN_TRAVEL_SPEED_4_LENGTH 600
#define TRAIN_TRAVEL_SPEED_4        3
#define TRAIN_TRAVEL_SPEED_5_LENGTH 50
